...
Verified under ASan with the allocator freelists disabled. ATS must survive the expiry.
'''
...
class RateLimitSniExpiryTest:
    ...
    def __init__(self) -> None:
        tr = Test.AddTestRun('rate_limit SNI queue max_age expiry under ASan')
