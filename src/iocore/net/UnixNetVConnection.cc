...
// Interface so inherited classes (IOUringNetVConnection) can call some static
// in-line functions without affecting regular net stuff or copying a bunch of
// code into the header files.
void
